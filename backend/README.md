...
## Project Structure
    ...
    ├── testapiautoconnecto_96381  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_96381`
...
2. Clone this repo and `cd testapiautoconnecto_96381`
